...
const Register = () => {
    const {createUser,googleSignUp,updateUserProfile} = useContext(AuthContex);
    ...
    const handlerSubmit = (event) =>{
        ...
        .then(result =>{
            ...
            handlerUpdateUserProfile(userName,photoUrl)
            console.log(user)
        })
    ...
    const handlerUpdateUserProfile = (userName,photoUrl)=>{
        const profile = {
    ...
    <form className="mt-6" onSubmit={handlerSubmit}>
        <div>
            ...
            <input type="text" name='userName' className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" required />
        </div>
        <div>
            <label htmlFor="username" className="block text-sm text-gray-800 dark:text-gray-200">PhotoUrl</label>
            <input type="text" name='photoUrl' className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" required/>
        </div>
        <div>
        ...
        <div className="mt-4">
             <label htmlFor="username" className="block text-sm text-gray-800 dark:text-gray-200">Password</label>
    ...
    <div className="flex items-center mt-6 -mx-2">
        <button onClick={handlerGoogle} type="button" className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
